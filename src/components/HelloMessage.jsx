  ...
  return (
    <section className="px-6">
      <div className="mx-auto max-w-5xl rounded-2xl bg-white/60 p-10 shadow-sm backdrop-blur dark:bg-slate-900/60">
        <h2 className="bg-gradient-to-br from-indigo-600 via-fuchsia-600 to-rose-600 bg-clip-text text-center text-5xl font-extrabold tracking-tight text-transparent sm:text-6xl">
          Hello, world!
        </h2>
